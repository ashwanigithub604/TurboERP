...
namespace TurboERP_DAL.App_DAL
{
    public class SalesCocls
    {
        ...
        //------Get Salesco-ordinator  In Grid-------
        public DataTable GetSalesCoordinotorGrid()
        {
            DataTable dt = null;
            try
            {
                cmd.Parameters.Add("@Action", SqlDbType.VarChar, 6).Value = "Grid";
                cmd.Parameters.Add("@Identifier", SqlDbType.VarChar, 10).Value = "SalesCo";
        ...
        //----Get Salesco-ordinator  For Edit  --------
        public DataTable GetSalesCoordinatorById(int PId)
        {
            DataTable dt = null;
            try
            {
        ...
        //---- Save Salesco-ordinator r  --------
        public int InsertSalesCoordinator(MisPrty misParty)
        {
            int result = 0;
            try
            {
        ...
        //---------Update Salesco-ordinator --------
        public int UpdateSalesCoordinator(MisPrty misPrty)
        {
            int result = 0;
            try
            {
        ...
        //----Delete Salesco-ordinator   --------
        public int DeleteSalesCo(int PID)
        {
            int result = 0;
            try
            {
